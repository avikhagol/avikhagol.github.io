...
The different Dark Matter models predict different estimation on the number density of the Dark Matter halos in sub-galactic scales ($\le 10^{11} M_{☉}$). Our research focuses on searching for the strong milli-lensing candidates with sub-galactic mass scales ($10^{6} \sim 10^9 M_{☉}$).
