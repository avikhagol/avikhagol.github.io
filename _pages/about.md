...
Our research focuses on searching for strong milli-lensing candidates with mass scales around $10^{6} \sim 10^9 M_{☉}$. The different Dark Matter models predict different estimation on the number density of the Dark Matter halos in sub-galactic scales ($\le 10^{11} M_{☉}$).
